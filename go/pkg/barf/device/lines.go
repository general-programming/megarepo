...
// the other separators Python recognises at all. Most of the parsers here
// TrimSpace each line afterwards, which hides the difference — but not
// all of them do: the `show version` fallback in ParseVyOSVersion returns
