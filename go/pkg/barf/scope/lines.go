...
// running-config text that arrives over eAPI from a device or a capture
// with CRLF endings: the scoped comparison must see the same lines the
// Python implementation saw, or it reports drift that is not there.
//
