...
engine = create_engine(
    os.environ["POSTGRES_URL"], convert_unicode=True, pool_recycle=3600
)
...
class Account(Base):
    ...
    def check_password(self, password):
        return (
            hashpw(password.encode("utf8"), self.password.encode()).decode("utf8")
            == self.password
        )
    ...
    def to_dict(self):
        return {
            ...
            "stripe_linked": hasattr(self, "stripe_customer")
            and self.stripe_customer != "",
        }
